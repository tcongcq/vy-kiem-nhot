...
(function(b, a) {
    b.fn.contextMenu = function(e) {
        var c = "contextmenu";
        return this.each(function() {
            b(this).on("contextmenu", function(g) {
                if (g.ctrlKey) {
                    return
                }
                if (e === undefined) {
                ...
                b("#" + c).remove();
                b("body").append('<ul id="' + c + '" class="dropdown-menu" role="menu" style="display:none" >' + e.init + "</ul>");
                var f = b("#" + c).data("invokedOn", b(this)).show().css({
                    position: "absolute",
                    left: d(g.clientX, "width", "scrollLeft"),
                    top: d(g.clientY, "height", "scrollTop")
                }).off("click").on("click", "a", function(i) {
                    f.hide();
                    var h = f.data("invokedOn");
                    var j = b(this);
                    e.menuSelected.call(this, h, j)
                });
                return false
            });
...
String.prototype.latinise = function() {
    var a = this;
    a = a.replace(/å|ä|ā|à|á|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ|ặ|ẳ|ẵ|ä|ą/g, "a");
    a = a.replace(/ß|ḃ/g, "b");
    a = a.replace(/ç|ć|č|ĉ|ċ|¢|©/g, "c");
    a = a.replace(/đ|ď|ḋ|đ/g, "d");
    a = a.replace(/è|é|ẹ|ẻ|ẽ|ê|ề|ế|ệ|ể|ễ|ę|ë|ě|ė/g, "e");
    a = a.replace(/ḟ|ƒ/g, "f");
    a = a.replace(/ķ/g, "k");
    a = a.replace(/ħ|ĥ/g, "h");
    a = a.replace(/ì|í|î|ị|ỉ|ĩ|ï|î|ī|¡|į/g, "i");
    a = a.replace(/ĵ/g, "j");
    a = a.replace(/ṁ/g, "m");
    a = a.replace(/ö|ò|ó|ọ|ỏ|õ|ô|ồ|ố|ộ|ổ|ỗ|ơ|ờ|ớ|ợ|ở|ỡ|ö|ø|ō/g, "o");
    a = a.replace(/ṗ/g, "p");
    a = a.replace(/ġ|ģ|ğ|ĝ/g, "g");
    a = a.replace(/ü|ù|ú|ū|ụ|ủ|ũ|ư|ừ|ứ|ự|ử|ữ|ü|ų|ů/g, "u");
    a = a.replace(/ỳ|ý|ỵ|ỷ|ỹ|ÿ/g, "y");
    a = a.replace(/ń|ñ|ň|ņ/g, "n");
    a = a.replace(/ŝ|š|ś|ṡ|ș|ş|³/g, "s");
    a = a.replace(/ř|ŗ|ŕ/g, "r");
    a = a.replace(/ṫ|ť|ț|ŧ|ţ/g, "t");
    a = a.replace(/ź|ż|ž/g, "z");
    a = a.replace(/ł|ĺ|ļ|ľ/g, "l");
    a = a.replace(/ẃ|ẅ/g, "w");
    a = a.replace(/æ/g, "ae");
    a = a.replace(/þ/g, "th");
    a = a.replace(/ð/g, "dh");
...
ko.components.register("filemanager", {
    viewModel: function(h) {
        ...
        var a = true;
        var f;
        c.extension_filters = function(i) {
            var j = [];
            $.each(i, function() {
                if (j.indexOf(this.extension) < 0) {
                    j.push(this.extension)
                }
            });
            return j
        };
        c.contextMenuInit = function() {
            $(document).contextMenu();
            $(".thumb-folder").contextMenu({
                init: '<li><a tabindex="-1" href="#" data-action="rename"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> ' + h.labels.rename + "</a></li>",
                menuSelected: function(j, i) {
                    switch (i.attr("data-action")) {
                        case "rename":
                            c.rename(JSON.parse(j.attr("data-raw")));
                            break
                    }
                }
            });
            $("#lightgallery .item[data-type='photo']").contextMenu({
                init: '<li><a tabindex="-1" href="#" data-action="choose">                            <b><i class="fa fa-check" aria-hidden="true"></i> ' + h.labels.choose + '</b>                        </a></li>                        <li class="divider"></li>                        <li><a tabindex="-1" href="#" data-action="rename">                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> ' + h.labels.rename + '                        </a></li>                        <li><a tabindex="-1" href="#" data-action="photo-editor">                            <i class="fa fa-paint-brush" aria-hidden="true"></i> ' + h.labels.edit + '                        </a></li>                        <li><a tabindex="-1" href="#" data-action="download">                            <i class="fa fa-cloud-download" aria-hidden="true"></i> ' + h.labels.download + "                        </a></li>",
                menuSelected: function(j, i) {
                    switch (i.attr("data-action")) {
                        case "choose":
                            c.chooseItem(JSON.parse(j.attr("data-raw")));
                            break;
                        case "rename":
                            c.rename(JSON.parse(j.attr("data-raw")));
                            break;
                        case "photo-editor":
                            c.photoEditor(JSON.parse(j.attr("data-raw")));
                            break;
                        case "download":
                            c.download(JSON.parse(j.attr("data-raw")));
                            break
                    }
                }
            });
            $("#lightgallery .item[data-type='file']").contextMenu({
                init: '<li><a tabindex="-1" href="#" data-action="choose">                            <b><i class="fa fa-check" aria-hidden="true"></i> ' + h.labels.choose + '</b>                        </a></li>                        <li class="divider"></li>                        <li><a tabindex="-1" href="#" data-action="rename">                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> ' + h.labels.rename + '                        </a></li>                        <li><a tabindex="-1" href="#" data-action="download">                            <i class="fa fa-cloud-download" aria-hidden="true"></i> ' + h.labels.download + "                        </a></li>",
                menuSelected: function(j, i) {
                    switch (i.attr("data-action")) {
                        case "choose":
        ...
        c.photoEditor = function(i) {
            ...
            $("#flip-h").on("click", function() {
                c.cropper().scaleX(parseInt($(this).attr("data-option")));
                $(this).attr("data-option", parseInt($(this).attr("data-option")) == -1 ? 1 : -1)
            });
            $("#flip-v").on("click", function() {
                c.cropper().scaleY(parseInt($(this).attr("data-option")));
                $(this).attr("data-option", parseInt($(this).attr("data-option")) == -1 ? 1 : -1)
            });
            $("#accept").on("click", function() {
                $(".photo-editor .photo-preview").html(c.cropper().getCroppedCanvas());
                $(".photo-editor").addClass("preview")
            });
            $("#c-undo").on("click", function() {
                $(".photo-editor .photo-preview").html("");
                $(".photo-editor").removeClass("preview")
            });
            $("#c-save").on("click", function() {
                c.cropper().getCroppedCanvas().toBlob(function(k) {
                    var l = new FormData();
                    l.append("_token", h.token);
                    l.append("extension", c.current().extension);
                    l.append("filename", c.current().filename);
                    l.append("path", c.path());
                    l.append("file", k);
                    $.ajax(h.url + "/save-photo-editor", {
                        method: "POST",
                        data: l,
                        processData: false,
                        contentType: false,
                        ...
                        success: function(m) {
                            ...
                            toastr[m.status](m.message)
                        },
                        error: function() {
                            toastr.error(h.labels.error_connection)
                        }
                    })
                })
            });
        ...
        c.status_info = ko.pureComputed(function() {
            var i = 0;
            var j = 0;
            var k = "";
            switch (c.viewMode()) {
                case "grid":
                    if (c.ids().length == 0) {
                        if (c.filter() === "") {
                            files = c.photos().length + c.videos().length + c.audios().length + c.files().length
                        } else {
                            files = (c.filter() == "photos" ? c.photos().length : ko.utils.arrayFilter(c.photos(), function(l) {
                                return l.extension == c.filter()
                            }).length);
                            files += (c.filter() == "videos" ? c.videos().length : ko.utils.arrayFilter(c.videos(), function(l) {
                                return l.extension == c.filter()
                            }).length);
                            files += (c.filter() == "audios" ? c.audios().length : ko.utils.arrayFilter(c.audios(), function(l) {
                                return l.extension == c.filter()
                            }).length);
                            files += (c.filter() == "audios" ? c.audios().length : ko.utils.arrayFilter(c.audios(), function(l) {
                                return l.extension == c.filter()
                            }).length);
                            files += (c.filter() == "files" ? c.files().length : ko.utils.arrayFilter(c.files(), function(l) {
                                return l.extension == c.filter()
                            }).length)
                        }
                        if (files) {
                            k += files + " " + (files > 1 ? h.labels.files : h.labels.file)
                        }
                        if (c.folders().length) {
                            k += (files ? ", " : " ") + c.folders().length + " " + (c.folders().length > 1 ? h.labels.folders : h.labels.folder)
                        }
                    } else {
                        k = h.labels.selected;
                        j = ko.utils.arrayFilter(c.ids(), function(l) {
                            return l.type == "folder"
                        }).length;
                        i = c.ids().length - j;
                        if (i) {
                            k += " " + i + " " + (i > 1 ? h.labels.files : h.labels.file)
                        }
                        if (j) {
                            k += (i ? ", " : " ") + j + " " + (j > 1 ? h.labels.folders : h.labels.folder)
                        }
                    }
                    break
            }
        ...
        c.upload_info = ko.pureComputed(function() {
            var i = "";
            if (c.uploadsuccess() == 0) {
                i = h.labels.uploading
            } else {
                i = h.labels.uploaded + " " + c.uploadsuccess() + " " + (c.uploadsuccess() > 1 ? h.labels.files : h.labels.file)
            }
            return i
        });
        c.filemanager_rendered = function() {
            $('[data-toggle="tooltip"]').tooltip({
                placement: "bottom"
            });
            $(".upload #fileupload").on("change", function() {
                var i = $(this)[0].files;
                c.uploadsuccess(0);
                d(i);
                $(".upload #fileupload").val("")
            });
            $(document).on("dragover", function(i) {
                i.stopPropagation();
                i.preventDefault()
            ...
            $(".grid-view").on("dragover", function(i) {
                $(this).addClass("drag");
                i.stopPropagation();
                i.preventDefault()
                ...
                j.preventDefault();
                $(this).removeClass("drag");
                var i = j.originalEvent.dataTransfer.files;
                d(i)
            })
        };
        c.gotoFolder = function(i) {
            c.path(i);
            c.uploadprogress(false)
        };
        c.doFilter = function(j, i) {
            c.ids([]);
            c.destroy_lg();
            c.filter(j);
            c.filter_label(i);
        ...
        c.destroy_lg = function() {
            try {
                var i = document.getElementById("lightgallery");
                lightGallery(i);
                window.lgData[i.getAttribute("lg-uid")].destroy(true)
            } catch (j) {
                c.destroy_lg()
            }
        };
            ...
            $.ajax({
                ...
                success: function(i) {
                    if (i.status == "success") {
                        ...
                        c.ids([]);
                        c.filter("");
                        c.filter_label(h.labels.all);
                        g = i.disk_space;
                        b = i.disk_space_usage;
                        a = false;
                        c.disk_space_info(h.labels.disk_space + " (" + b + "/" + g + "MB)");
                        c.disk_space_percent_info((b * 100) / g);
                        $("#lightgallery").removeAttr("lg-uid");
                        lightGallery(document.getElementById("lightgallery"), {
                            thumbnail: true,
                            selector: ".item-preview"
                        ...
                        toastr[i.status](i.message)
                    }
                }
            })
        };
        c.select_item = function(i) {
            if ($.inArray(i, c.ids()) >= 0) {
                c.ids.remove(i)
            } else {
                c.ids.push(i)
            }
        };
        c.select_all = function(i) {
            c.ids([]);
            switch (i) {
                case "folders":
                    $.each(c.folders(), function() {
                        c.ids.push(this)
                    });
                    break;
                case "files":
                    $.each((c.filter() == "" || c.filter() == "photos" ? c.photos() : ko.utils.arrayFilter(c.photos(), function(j) {
                        return j.extension == c.filter()
                    })), function() {
                        c.ids.push(this)
                    });
                    $.each((c.filter() == "" || c.filter() == "videos" ? c.videos() : ko.utils.arrayFilter(c.videos(), function(j) {
                        return j.extension == c.filter()
                    })), function() {
                        c.ids.push(this)
                    });
                    $.each((c.filter() == "" || c.filter() == "audios" ? c.audios() : ko.utils.arrayFilter(c.audios(), function(j) {
                        return j.extension == c.filter()
                    })), function() {
                        c.ids.push(this)
                    });
                    $.each((c.filter() == "" || c.filter() == "files" ? c.files() : ko.utils.arrayFilter(c.files(), function(j) {
                        return j.extension == c.filter()
                    })), function() {
                        c.ids.push(this)
                    });
        ...
        c.createDir = function() {
            $.ajax({
                url: h.url + "/create-dir",
                type: "post",
                data: {
                    _token: h.token,
                    dirname: $("#dirname").val(),
        ...
        c.rename = function(i) {
            c.current(i);
            $("#new_filename").val(c.current().filename);
        ...
        c.upload = function() {
            $(".upload #fileupload")[0].click()
        };
        c.closeUploadProgress = function() {
            $(".upload .uploadbar .list-group").html("");
            c.uploadprogress(false)
        };
        c.back = function() {
            c.viewMode("grid")
        ...
        function d(l) {
            ...
            for (var k = 0; k < l.length && c.uploadprogress(); k++) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {},
                    error: function() {
                        var i = this.data.get("idx");
                        var n = this.data.get("file");
                        $(".upload .uploadbar .list-group #idx" + i + " #res").html("");
                        $(".upload .uploadbar .list-group #idx" + i + " #filename").html('<i class="error">(' + h.labels.error + ")</i> " + n.name)
                    },
                    xhr: function() {
                        var n = new window.XMLHttpRequest();
                        var i = this.data.get("idx");
                        n.upload.addEventListener("progress", function(o) {
                            e(o, i)
                        }, false);
                        return n
                    },
                    success: function(o) {
                        ...
                        var n = this.data.get("file");
                        if (o.status == "success") {
                            c.uploadsuccess(c.uploadsuccess() + 1);
                            $(".upload .uploadbar .list-group #idx" + i + " > #res").html('<i class="fa fa-check" aria-hidden="true"></i>');
                            a = true;
                            c.fetch()
                        } else {
                            $(".upload .uploadbar .list-group #idx" + i + " #res").html("");
                            $(".upload .uploadbar .list-group #idx" + i + " #filename").html('<i class="error">(' + (o.message === undefined ? h.labels.error : o.message) + ")</i> " + n.name)
                        }
                    }
                })
            }
        ...
        function e(j, i) {
            if (j.lengthComputable) {
                var l = j.loaded / j.total;
                var k = Math.floor(l * 100);
                var m = ((100 - (l * 100)) / 100) * (Math.PI * (15 * 2));
                $(".upload .uploadbar .list-group #idx" + i + " #res #pro").css("stroke-dashoffset", m + "px");
                $(".upload .uploadbar .list-group #idx" + i + " #res text").html(k < 10 ? ("0" + k + "%") : (k + "%"))
            }
        }
        c.chooseItem = function(ids) {
        	...
        	switch (h.type) {
                case "CKEditor":
                    window.opener.CKEDITOR.tools.callFunction(h.CKEditorFuncNum, h.public_path + res_path);
                    break;
                case "imageID":
                    $("#" + h.fieldID, window.opener.document).attr("src", h.public_path + res_path);
                    $("#" + h.fieldID, window.opener.document).attr("data-src", res_path);
                    break;
                case "backgroundID":
                    $("#" + h.fieldID, window.opener.document).css("background-image", "url(" + h.public_path + res_path + ")");
                    $("#" + h.fieldID, window.opener.document).attr("data-src", res_path);
                    break;
                default:
                    $("#" + h.fieldID, window.opener.document).val(res_path);
                    window.opener.$("#" + h.fieldID).trigger("change");
                    break;
            }
            if (h.callback != "") {
                window.opener[h.callback](res_path)
            }
            window.close()
        };
        c.download = function(j) {
            var i = $("<a>").attr("href", h.public_path + j.path).attr("download", j.filename).appendTo("body");
            i[0].click();
            i.remove()
        };
        c.doSearch = function(j, i) {
            c.ids([]);
            c.destroy_lg();
            c.search($(i.target).val());
            $("#lightgallery").removeAttr("lg-uid");
            $("#lightgallery").removeAttr("lg-event-uid");
            lightGallery(document.getElementById("lightgallery"), {
                thumbnail: true,
        ...
        c.clearSearch = function(j, i) {
            $(i.target).parent().children("input").val("");
            c.ids([]);
            c.destroy_lg();
            c.search("");
            $("#lightgallery").removeAttr("lg-uid");
