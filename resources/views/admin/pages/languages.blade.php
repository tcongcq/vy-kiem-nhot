...
function ToolBar() {
    ...
    self.prepare_save = function(){
    	self.form_data.current().default = self.form_data.current().default == true ? 1 : 0;
    };
    ...
    self.cellsrenderer = {
    	default: function(data){
            if (data.default == 1)
                return '<span class="badge badge-success"><span class="fa fa-check"></span></span>'
        }
    };
}
