                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="selectpicker show-tick form-control" filter-colname="product_category_id" filter-operator="in" data-live-search="true" multiple data-selected-text-format="count > 3" data-actions-box="true">
