...
<div class="page-wrapper">
	            ...
	            <div class="vc_column-inner vc_custom_1537259019394">
	                <div class="wpb_wrapper">
	                    ...
	                    <div class="vc_row wpb_row vc_inner vc_row-fluid contact-details">
	                        <div class="contact-info contact-main wpb_column vc_column_container vc_col-sm-4">
	                            <div class="vc_column-inner">
	                                <div class="wpb_wrapper">
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h3 style="text-align: left;">
	                                                <span style="color: #000000;">Head Office</span>
	                                            </h3>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h4 style="text-align: center;">Sanjalee Tharuka</h4>
	                                            <p>
	                                                <strong>Sales Coordinator</strong>
	                                                <br>
	                                                <span style="color: #ff0000;">sanjalee@interocean.lk</span>
	                                                <br>
	                                                <b class="flaticon-telephone"></b>
	                                                <a href="tel:+94770038757">+94 77 0038 757</a>
	                                            </p>
	                                        </div>
	                                    </div>
	                                </div>
	                            ...
	                            <div class="vc_column-inner">
	                                <div class="wpb_wrapper">
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h3 style="text-align: left;">
	                                                <span style="color: #000000;">Industrial <br>
	                                                </span>
	                                            </h3>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h4 style="text-align: center;">Romesh Goonawardena</h4>
	                                            <p>
	                                                <strong>Senior Sales Manager</strong>
	                                                <br>
	                                                <b class="flaticon-note"></b>
	                                                <a href="mailto:romesh@interocean.lk">romesh@interocean.lk</a>
	                                                <br>
	                                                <b class="flaticon-telephone"></b>
	                                                <a href="tel:+94770038774">+94 77 0038 774</a>
	                                            </p>
	                                        </div>
	                                    </div>
	                                </div>
	                        ...
	                        <div class="contact-info contact-main wpb_column vc_column_container vc_col-sm-4">
	                            <div class="vc_column-inner">
	                                <div class="wpb_wrapper">
	                                    ...
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h4 style="text-align: center;">Dumindu De Silva</h4>
	                                            <p style="text-align: left;">
	                                                <strong>Sales Manager</strong>
	                                                <br>
	                                                <b class="flaticon-note"></b>
	                                                <a href="mailto:dumindu@interocean.lk">dumindu@interocean.lk</a>
	                                                <br>
	                                                <b class="flaticon-telephone"></b>
	                                                <a href="tel:+94770038747">+94 77 0038 747</a>
	                                            </p>
	                                        </div>
	                                    </div>
	                                </div>
	...
	<div class="vc_row wpb_row vc_row-fluid">
	    <div class="container">
	        <div class="contact-sale wpb_column vc_column_container vc_col-sm-12">
	            <div class="vc_column-inner vc_custom_1537260607737">
	                <div class="wpb_wrapper">
	                            ...
	                            <div class="vc_column-inner">
	                                <div class="wpb_wrapper">
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h3 style="text-align: left;">
	                                                <span style="color: #000000;">Consultant Lube</span>
	                                            </h3>
	                                        </div>
	                                    </div>
	                                    <div class="vc_empty_space" style="height: 20px">
	                                    ...
	                                    <div class="wpb_text_column wpb_content_element ">
	                                        <div class="wpb_wrapper">
	                                            <h4 style="text-align: center;">B M Dayaratne</h4>
	                                            <p>
	                                                <strong>Consultant – Lube</strong>
	                                                <br>
	                                                <b class="flaticon-note"></b>
	                                                <a href="mailto:dayaratne@interocean.lk">dayaratne@interocean.lk</a>
	                                                <br>
	                                                <b class="flaticon-telephone"></b>
	                                                <a href="tel:+94772555550">+94 77 255 5550</a>
	                                            </p>
	                        ...
	                        <div class="row">
	                            <div class="col-md-4">
	                                <div class="getin-touch">
	                                    ...
	                                    <p>Interocean Lubricants (Pvt) Ltd. incorporated in 2008 serves as the Sole Distributor for Sinopec in Sri Lanka</p>
	                                    <ul class="contact-info">
	                                        <li class="address">
	                                            ...
	                                            <div class="content">
	                                                <h4>Address :</h4>
	                                                <p>371, Negombo Road, Wattala 11300, Sri Lanka</p>
	                                            </div>
	                                        </li>
	                                        <li class="email">
	                                            <div class="icon-holder">
	                                    ...
	                                    <div role="form" class="wpcf7" id="wpcf7-f597-p598-o1" lang="en-US" dir="ltr">
	                                        ...
	                                        <form action="/get-in-touch/#wpcf7-f597-p598-o1" method="post" class="wpcf7-form init" novalidate="novalidate">
	                                            <div style="display: none;">
	                                                ...
	                                                <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f597-p598-o1">
	                                                <input type="hidden" name="_wpcf7_container_post" value="598">
	                                                <input type="hidden" name="_wpcf7_posted_data_hash" value="">
	                                                <input type="hidden" name="_wpcf7_recaptcha_response" value="03AFY_a8W7QjSR73ZNwg2jyhxQnWbR_vdgko67tz4hmDU8SztdByg3V4kmqIm8P4AIcWWCB7N1McziMlQqopTaszz8IV9KOfw3SiY6yxU9QVgjzOz4yc-aDDEBH5Zqh4vH7xR8Nkykw6_6fht6uYummRut33eDrLrgwzsyp0jpq0FcEzkmltkRwEgwkyfA4cJgZeYDbZ0ovE7WMva_oOpDvgPvjVNC7sSSh3jmREmCycjYTK12NEQSE2ObnxErQmfIkyklKScZf0rnvUGS9LMnXgGiZShU4ktoPZ71XNAH6acK1ud0RA-6_Do5cO15HH_SmSS2C7qkjjJk6Uh7p1bb8Ukzl5URJaKBYwoOH2WtWzWcYbz6WCWoE8EWLcFiq5BY_bsywMOe0n0FWIGMloCWfQdOOgmZMPss4hTEbP1lYMoslEeBEzUVP7xwC-6Wy4EwuP76cZTZ9wxeJyBON25Klw1Ampc3mQ_eSuMwazuag_QIjlfk-XM2QUjaGGicfLiYKTm06K4VK-oV1itmrcmK6IzB_Ml_Y4aTCjT3iGeMUoIMXz7zmYLTYJ3eHtZkBO5qRO8jHJ1eye8O">
	                                            </div>
	                                            <div class="row">
	                                                <div class="col-md-6">
